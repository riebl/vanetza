...
void Router::on_beacon_timer_expired()
{
    ...
    if (m_mib.itsGnSecurity) {
        ...
        payload = encap_packet(security::itsAidGnMgmt, *pdu, std::move(payload));
    } else {
...
Router::DownPacketPtr Router::encap_packet(security::IntX its_aid, Pdu& pdu, DownPacketPtr packet)
{
