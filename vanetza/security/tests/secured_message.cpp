...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_1)
{
    ...
    const char str[] =
        "0281038002010901A8ED6DF65B0E6D6A0100809400000418929DB6A9E452223062C52028E956BF98"
...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_2)
{
    // SecuredMessage/v1 from FOKUS WebValidator adapted for v2
    const char str[] =
        "0281038002010901A8ED6DF65B0E6D6A01008094000004C4EC137145DD4F450145DE530CCA36E73A"
...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_3)
{
    // SecuredMessage/v1 from FOKUS WebValidator adapted for v2
    const char str[] =
        "0281038002010901A8ED6DF65B0E6D6A010080940000040209B0434163CCBAFDD34A45333E418FB9"
