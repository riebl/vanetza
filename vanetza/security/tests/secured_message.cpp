...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_1)
{
    ...
    const char str[] =
        "02810280020201A8ED6DF65B0E6D6A0100809400000418929DB6A9E452223062C52028E956BF98"
        ...
        "785D7242647F7895ABFC0000009373931CD758050002011C983E690E5F6D755BD4871578A9427E7B"
...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_2)
{
    // SecuredMessage/v1 from FOKUS WebValidator adapted for v2
    const char str[] =
        "02810280020201A8ED6DF65B0E6D6A01008094000004C4EC137145DD4F450145DE530CCA36E73A"
        ...
        "94677AF24917E51B80AC0000009373CC5F22C80500020120F29384759027349075829034707ABABA"
...
TEST(SecuredMessage, WebValidator_Serialize_SecuredMessageV2_3)
{
    // SecuredMessage/v1 from FOKUS WebValidator adapted for v2
    const char str[] =
        "02810280020201A8ED6DF65B0E6D6A010080940000040209B0434163CCBAFDD34A45333E418FB9"
        ...
        "98F7865709929A7C6E480000009373CF482D4005000201080123456789ABCDEF43010000371423BB"
