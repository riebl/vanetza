...
TEST(WebValidator, Serialize_SecuredMessage2)
{
    char str[] =
...
TEST(WebValidator, Serialize_SecuredMessage3)
{
    char str[] =
...
TEST(WebValidator, Serialize_Certificate_RootCA)
{
    char str[] =
...
TEST(WebValidator, Serialize_Certificate_EnrollmentAuthority)
{
    char str[] =
...
TEST(WebValidator, Serialize_Certificate_AuthorizationAuthority1)
{
    char str[] =
...
TEST(WebValidator, Serialize_Certificate_AuthorizationAuthority2)
{
    char str[] =
...
TEST(WebValidator, Serialize_Certificate_AuthorizationAuthority3)
{
    char str[] =
