...
Certificate_t CertificateV3::as_plain_certificate() const{
    vanetza::ByteBuffer cert = this->certificate.encode();
    vanetza::asn1::Ieee1609Dot2Certificate temp;
    temp.decode(cert);
    return *temp;
}// TODO
...
ByteBuffer CertificateV3::convert_for_signing() const {
    ...
    vanetza::asn1::free(asn_DEF_ToBeSignedCertificate, to_be_signed.get());
    return bytes;
}// Test to be written
