...
TrustStore::TrustStore(std::vector<Certificate> trusted_certificates)
{
...
std::vector<Certificate> TrustStore::find_by_id(HashedId8 id)
{
    typedef std::multimap<HashedId8, Certificate>::iterator iterator;
