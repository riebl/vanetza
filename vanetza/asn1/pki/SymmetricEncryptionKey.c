...
asn_TYPE_member_t asn_MBR_SymmetricEncryptionKey_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SymmetricEncryptionKey, choice.aes128Ccm),
		...
		0,
		{ &asn_OER_memb_aes128Ccm_constr_2, &asn_PER_memb_aes128Ccm_constr_2,  memb_aes128Ccm_constraint_1 },
...
asn_TYPE_descriptor_t asn_DEF_SymmetricEncryptionKey = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_SymmetricEncryptionKey_constr_1, &asn_PER_type_SymmetricEncryptionKey_constr_1, CHOICE_constraint },
