...
/*
 * This type is implemented using EtsiTs103097Data_Encrypted_Unicast_55P0,
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_AuthorizationRequestMessage_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_AuthorizationRequestMessage_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_AuthorizationRequestMessage = {
	...
	sizeof(asn_DEF_AuthorizationRequestMessage_tags_1)
		/sizeof(asn_DEF_AuthorizationRequestMessage_tags_1[0]), /* 1 */
	{ &asn_OER_type_AuthorizationRequestMessage_constr_1, &asn_PER_type_AuthorizationRequestMessage_constr_1, AuthorizationRequestMessage_constraint },
