...
typedef EtsiTs103097Data_SignedAndEncrypted_Unicast_64P0_t	 AuthorizationRequestMessageWithPop_t;
...
jer_type_encoder_f AuthorizationRequestMessageWithPop_encode_jer;
...
per_type_decoder_f AuthorizationRequestMessageWithPop_decode_uper;
per_type_encoder_f AuthorizationRequestMessageWithPop_encode_uper;
per_type_decoder_f AuthorizationRequestMessageWithPop_decode_aper;
per_type_encoder_f AuthorizationRequestMessageWithPop_encode_aper;
