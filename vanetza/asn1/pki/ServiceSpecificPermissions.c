...
asn_TYPE_member_t asn_MBR_ServiceSpecificPermissions_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ServiceSpecificPermissions, choice.opaque),
		...
		0,
		{ &asn_OER_memb_opaque_constr_2, &asn_PER_memb_opaque_constr_2,  memb_opaque_constraint_1 },
...
asn_TYPE_descriptor_t asn_DEF_ServiceSpecificPermissions = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_ServiceSpecificPermissions_constr_1, &asn_PER_type_ServiceSpecificPermissions_constr_1, CHOICE_constraint },
