...
static asn_TYPE_member_t asn_MBR_ConnectionManeuverAssist_addGrpC_1[] = {
	{ ATF_POINTER, 2, offsetof(struct ConnectionManeuverAssist_addGrpC, itsStationPositions),
	...
	{ ATF_POINTER, 1, offsetof(struct ConnectionManeuverAssist_addGrpC, rsuGNSSOffset),
...
static const int asn_MAP_ConnectionManeuverAssist_addGrpC_oms_1[] = { 0, 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_ConnectionManeuverAssist_addGrpC_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* itsStationPositions */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rsuGNSSOffset */
};
