...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_FrontOverhang_constr_1;
...
per_type_decoder_f FrontOverhang_decode_aper;
per_type_encoder_f FrontOverhang_encode_aper;
