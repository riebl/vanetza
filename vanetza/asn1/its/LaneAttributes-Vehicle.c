...
asn_oer_constraints_t asn_OER_type_LaneAttributes_Vehicle_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_jer_constraints_t asn_JER_type_LaneAttributes_Vehicle_constr_1 CC_NOTUSED = {
	-1};
