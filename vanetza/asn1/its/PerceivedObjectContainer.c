...
static asn_oer_constraints_t asn_OER_type_PerceivedObjectContainer_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
asn_per_constraints_t asn_PER_type_PerceivedObjectContainer_constr_1 CC_NOTUSED = {
...
asn_SET_OF_specifics_t asn_SPC_PerceivedObjectContainer_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PerceivedObjectContainer = {
	...
	sizeof(asn_DEF_PerceivedObjectContainer_tags_1)
		/sizeof(asn_DEF_PerceivedObjectContainer_tags_1[0]), /* 1 */
	{ &asn_OER_type_PerceivedObjectContainer_constr_1, &asn_PER_type_PerceivedObjectContainer_constr_1, SEQUENCE_OF_constraint },
