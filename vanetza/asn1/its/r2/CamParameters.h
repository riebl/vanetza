...
struct Vanetza_ITS2_WrappedExtensionContainers;
...
typedef struct Vanetza_ITS2_CamParameters {
	 ...
	 */
	struct Vanetza_ITS2_WrappedExtensionContainers	*extensionContainers;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_Vanetza_ITS2_CamParameters_1[5];
