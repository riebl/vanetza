...
int
ObjectAge_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_oer_constraints_t asn_OER_type_ObjectAge_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1500) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ObjectAge = {
	"ObjectAge",
	"ObjectAge",
	&asn_OP_NativeInteger,
	asn_DEF_ObjectAge_tags_1,
