...
static asn_oer_constraints_t asn_OER_type_SegmentAttribute_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_SegmentAttribute_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  6,  6,  0,  37 }	/* (0..37,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_SegmentAttribute_value2enum_1[] = {
	{ 0,	8,	"reserved" },
	{ 1,	10,	"doNotBlock" },
	{ 2,	9,	"whiteLine" },
...
static const unsigned int asn_MAP_SegmentAttribute_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_SegmentAttribute_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_SegmentAttribute_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_SegmentAttribute = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_SegmentAttribute_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
