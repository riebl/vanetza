...
static asn_TYPE_member_t asn_MBR_ext1_3[] = {
	{ ATF_POINTER, 1, offsetof(struct Reg_MapData__ext1, signalHeadLocations),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_3 = {
	sizeof(struct Reg_MapData__ext1),
	offsetof(struct Reg_MapData__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_Reg_MapData_1[] = {
	{ ATF_POINTER, 1, offsetof(struct Reg_MapData, ext1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_ext1_3,
		0,
...
static const int asn_MAP_Reg_MapData_oms_1[] = { 0 };
