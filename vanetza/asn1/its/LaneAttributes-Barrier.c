...
asn_oer_constraints_t asn_OER_type_LaneAttributes_Barrier_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_jer_constraints_t asn_JER_type_LaneAttributes_Barrier_constr_1 CC_NOTUSED = {
	16};
