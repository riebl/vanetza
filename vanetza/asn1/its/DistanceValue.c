...
int
DistanceValue_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_oer_constraints_t asn_OER_type_DistanceValue_constr_1 CC_NOTUSED = {
	{ 4, 0 }	/* (-132768..132767) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_DistanceValue = {
	"DistanceValue",
	"DistanceValue",
	&asn_OP_NativeInteger,
	asn_DEF_DistanceValue_tags_1,
