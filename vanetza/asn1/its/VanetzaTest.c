 ...
 * 	found in "vanetza/asn1/test.asn"
...
static int
memb_field_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static const ber_tlv_tag_t asn_DEF_VanetzaTest_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_VanetzaTest_tag2el_1[] = {
