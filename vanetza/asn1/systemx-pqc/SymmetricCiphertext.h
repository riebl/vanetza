...
typedef enum Vanetza_Security_SymmetricCiphertext_PR {
	...
	Vanetza_Security_SymmetricCiphertext_PR_sm4Ccm
...
typedef struct Vanetza_Security_SymmetricCiphertext {
	...
	union Vanetza_Security_SymmetricCiphertext_u {
		Vanetza_Security_One28BitCcmCiphertext_t	 aes128ccm;
		/*
		 * This type is extensible,
		 * possible extensions are below.
		 */
		Vanetza_Security_One28BitCcmCiphertext_t	 sm4Ccm;
	} choice;
...
extern asn_TYPE_member_t asn_MBR_Vanetza_Security_SymmetricCiphertext_1[2];
extern asn_oer_constraints_t asn_OER_type_Vanetza_Security_SymmetricCiphertext_constr_1;
