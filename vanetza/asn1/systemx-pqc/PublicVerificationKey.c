...
asn_oer_constraints_t asn_OER_type_Vanetza_Security_PublicVerificationKey_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_Vanetza_Security_PublicVerificationKey_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security_PublicVerificationKey, choice.ecdsaNistP384),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security_PublicVerificationKey, choice.ecsigSm2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security_PublicVerificationKey, choice.fnDsa512),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Vanetza_Security_FnDsa512Key,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_Vanetza_Security_PublicVerificationKey_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* fnDsa512 */
};
