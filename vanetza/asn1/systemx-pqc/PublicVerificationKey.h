...
typedef enum Vanetza_Security_PublicVerificationKey_PR {
	...
	Vanetza_Security_PublicVerificationKey_PR_ecdsaNistP384,
	Vanetza_Security_PublicVerificationKey_PR_ecsigSm2,
...
typedef struct Vanetza_Security_PublicVerificationKey {
	...
	union Vanetza_Security_PublicVerificationKey_u {
		...
		Vanetza_Security_EccP384CurvePoint_t	 ecdsaNistP384;
		Vanetza_Security_EccP256CurvePoint_t	 ecsigSm2;
		Vanetza_Security_FnDsa512Key_t	 fnDsa512;
	} choice;
...
extern asn_TYPE_member_t asn_MBR_Vanetza_Security_PublicVerificationKey_1[6];
extern asn_oer_constraints_t asn_OER_type_Vanetza_Security_PublicVerificationKey_constr_1;
