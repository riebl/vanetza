...
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security_Uint64 = {
	"Uint64",
	"Uint64",
	&asn_OP_INTEGER,
	asn_DEF_Vanetza_Security_Uint64_tags_1,
	sizeof(asn_DEF_Vanetza_Security_Uint64_tags_1)
		/sizeof(asn_DEF_Vanetza_Security_Uint64_tags_1[0]), /* 1 */
	asn_DEF_Vanetza_Security_Uint64_tags_1,	/* Same as above */
	sizeof(asn_DEF_Vanetza_Security_Uint64_tags_1)
		/sizeof(asn_DEF_Vanetza_Security_Uint64_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_Vanetza_Security_Uint64_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Vanetza_Security_Uint64_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
