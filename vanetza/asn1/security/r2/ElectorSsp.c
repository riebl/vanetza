...
asn_TYPE_member_t asn_MBR_Vanetza_Security2_ElectorSsp_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_ElectorSsp, version),
...
static const ber_tlv_tag_t asn_DEF_Vanetza_Security2_ElectorSsp_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Vanetza_Security2_ElectorSsp_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* version */
};
asn_SEQUENCE_specifics_t asn_SPC_Vanetza_Security2_ElectorSsp_specs_1 = {
	sizeof(struct Vanetza_Security2_ElectorSsp),
	offsetof(struct Vanetza_Security2_ElectorSsp, _asn_ctx),
	asn_MAP_Vanetza_Security2_ElectorSsp_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_ElectorSsp = {
	"ElectorSsp",
	"ElectorSsp",
	&asn_OP_SEQUENCE,
	asn_DEF_Vanetza_Security2_ElectorSsp_tags_1,
	sizeof(asn_DEF_Vanetza_Security2_ElectorSsp_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_ElectorSsp_tags_1[0]), /* 1 */
	asn_DEF_Vanetza_Security2_ElectorSsp_tags_1,	/* Same as above */
	sizeof(asn_DEF_Vanetza_Security2_ElectorSsp_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_ElectorSsp_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_Vanetza_Security2_ElectorSsp_1,
	1,	/* Elements count */
	&asn_SPC_Vanetza_Security2_ElectorSsp_specs_1	/* Additional specs */
};
