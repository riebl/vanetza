...
Vanetza_Security2_MultiSignedCtlSpdu_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	if(td->encoding_constraints.general_constraints != Vanetza_Security2_MultiSignedCtlSpdu_constraint) {
...
asn_oer_constraints_t asn_OER_type_Vanetza_Security2_MultiSignedCtlSpdu_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
