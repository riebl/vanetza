...
/*
 * This type is implemented using Vanetza_Security2_Uint64,
 * so here we adjust the DEF accordingly.
 */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_Vanetza_Security2_Time64_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_Time64 = {
	"Time64",
	"Time64",
	&asn_OP_INTEGER,
	asn_DEF_Vanetza_Security2_Time64_tags_1,
	sizeof(asn_DEF_Vanetza_Security2_Time64_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_Time64_tags_1[0]), /* 1 */
	asn_DEF_Vanetza_Security2_Time64_tags_1,	/* Same as above */
	sizeof(asn_DEF_Vanetza_Security2_Time64_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_Time64_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_Vanetza_Security2_Time64_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Vanetza_Security2_Time64_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
