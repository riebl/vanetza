...
static int
memb_Vanetza_Security2_content_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_Vanetza_Security2_content_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Vanetza_Security2_content_constr_4 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_Vanetza_Security2_permissions_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_CertRequestExtension__permissions, choice.content),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_Vanetza_Security2_content_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_Vanetza_Security2_content_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_Vanetza_Security2_content_constraint_3
		},
		0, 0, /* No default value */
		"content"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_CertRequestExtension__permissions, choice.all),
...
static asn_CHOICE_specifics_t asn_SPC_Vanetza_Security2_permissions_specs_3 = {
	sizeof(struct Vanetza_Security2_CertRequestExtension__permissions),
	offsetof(struct Vanetza_Security2_CertRequestExtension__permissions, _asn_ctx),
	offsetof(struct Vanetza_Security2_CertRequestExtension__permissions, present),
	sizeof(((struct Vanetza_Security2_CertRequestExtension__permissions *)0)->present),
...
asn_TYPE_member_t asn_MBR_Vanetza_Security2_CertRequestExtension_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_CertRequestExtension, id),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_CertRequestExtension, permissions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Vanetza_Security2_CertRequestExtension_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* permissions */
};
asn_SEQUENCE_specifics_t asn_SPC_Vanetza_Security2_CertRequestExtension_specs_1 = {
	sizeof(struct Vanetza_Security2_CertRequestExtension),
	offsetof(struct Vanetza_Security2_CertRequestExtension, _asn_ctx),
	asn_MAP_Vanetza_Security2_CertRequestExtension_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_CertRequestExtension = {
	"CertRequestExtension",
	"CertRequestExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1,
	sizeof(asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1[0]), /* 1 */
	asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1,	/* Same as above */
	sizeof(asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1)
		/sizeof(asn_DEF_Vanetza_Security2_CertRequestExtension_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	2,	/* Elements count */
	&asn_SPC_Vanetza_Security2_CertRequestExtension_specs_1	/* Additional specs */
};
