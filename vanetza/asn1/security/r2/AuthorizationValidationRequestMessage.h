...
#ifndef	_Vanetza_Security2_AuthorizationValidationRequestMessage_H_
#define	_Vanetza_Security2_AuthorizationValidationRequestMessage_H_
...
/* Vanetza_Security2_AuthorizationValidationRequestMessage */
typedef Vanetza_Security2_EtsiTs103097Data_SignedAndEncrypted_Unicast_115P0_t	 Vanetza_Security2_AuthorizationValidationRequestMessage_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_AuthorizationValidationRequestMessage;
asn_struct_free_f Vanetza_Security2_AuthorizationValidationRequestMessage_free;
asn_struct_print_f Vanetza_Security2_AuthorizationValidationRequestMessage_print;
asn_constr_check_f Vanetza_Security2_AuthorizationValidationRequestMessage_constraint;
ber_type_decoder_f Vanetza_Security2_AuthorizationValidationRequestMessage_decode_ber;
der_type_encoder_f Vanetza_Security2_AuthorizationValidationRequestMessage_encode_der;
...
per_type_encoder_f Vanetza_Security2_AuthorizationValidationRequestMessage_encode_uper;
...
#endif	/* _Vanetza_Security2_AuthorizationValidationRequestMessage_H_ */
