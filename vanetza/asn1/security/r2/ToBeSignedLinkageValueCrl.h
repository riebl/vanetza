...
#ifndef	_Vanetza_Security2_ToBeSignedLinkageValueCrl_H_
#define	_Vanetza_Security2_ToBeSignedLinkageValueCrl_H_
...
} Vanetza_Security2_ToBeSignedLinkageValueCrl_t;
