...
#ifndef	_Vanetza_Security_SequenceOfHashedId3_H_
#define	_Vanetza_Security_SequenceOfHashedId3_H_
...
/* Vanetza_Security_SequenceOfHashedId3 */
typedef struct Vanetza_Security_SequenceOfHashedId3 {
	A_SEQUENCE_OF(Vanetza_Security_HashedId3_t) list;
...
#endif	/* _Vanetza_Security_SequenceOfHashedId3_H_ */
