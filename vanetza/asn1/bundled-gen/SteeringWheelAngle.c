...
static asn_TYPE_member_t asn_MBR_SteeringWheelAngle_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SteeringWheelAngle, steeringWheelConfidence),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SteeringWheelConfidence,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
...
static asn_TYPE_tag2member_t asn_MAP_SteeringWheelAngle_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* steeringWheelConfidence */
};
