...
#include "EmptyRSUContainerHighFrequency.h"
...
typedef enum HighFrequencyContainer_PR {
	...
	HighFrequencyContainer_PR_emptyRSUContainerHighFrequency,
...
typedef struct HighFrequencyContainer {
	...
	union HighFrequencyContainer_u {
		...
		EmptyRSUContainerHighFrequency_t	 emptyRSUContainerHighFrequency;
		/*
