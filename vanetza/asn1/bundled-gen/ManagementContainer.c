...
static int asn_DFL_10_set_600(int set_value, void **sptr) {
...
static asn_TYPE_member_t asn_MBR_ManagementContainer_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, isNegation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, isCancellation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, relevanceDistance),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, relevanceTrafficDirection),
	...
	{ ATF_POINTER, 2, offsetof(struct ManagementContainer, validityDuration),
		...
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		asn_DFL_10_set_600,	/* DEFAULT 600 */
		"validityDuration"
		},
...
static int asn_MAP_ManagementContainer_oms_1[] = { 8, 9 };
...
static asn_TYPE_tag2member_t asn_MAP_ManagementContainer_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* isNegation */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* isCancellation */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* eventPosition */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* relevanceDistance */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* relevanceTrafficDirection */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* validityDuration */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* transmissionInterval */
};
