...
static asn_TYPE_member_t asn_MBR_BasicVehicleContainerHighFrequency_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct BasicVehicleContainerHighFrequency, performanceClass),
	...
	{ ATF_POINTER, 5, offsetof(struct BasicVehicleContainerHighFrequency, accelerationControl),
	...
	{ ATF_POINTER, 4, offsetof(struct BasicVehicleContainerHighFrequency, laneNumber),
	...
	{ ATF_POINTER, 3, offsetof(struct BasicVehicleContainerHighFrequency, steeringWheelAngle),
	...
	{ ATF_POINTER, 2, offsetof(struct BasicVehicleContainerHighFrequency, lateralAcceleration),
	...
	{ ATF_POINTER, 1, offsetof(struct BasicVehicleContainerHighFrequency, verticalAcceleration),
...
static int asn_MAP_BasicVehicleContainerHighFrequency_oms_1[] = { 9, 10, 11, 12, 13, 14 };
...
static asn_TYPE_tag2member_t asn_MAP_BasicVehicleContainerHighFrequency_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* longitudinalAcceleration */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* curvature */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* curvatureCalculationMode */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* yawRate */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* vehicleLength */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* vehicleWidth */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* performanceClass */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* accelerationControl */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* laneNumber */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 12, 0, 0 }, /* steeringWheelAngle */
