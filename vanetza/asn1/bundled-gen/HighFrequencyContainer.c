...
static asn_TYPE_member_t asn_MBR_HighFrequencyContainer_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighFrequencyContainer, choice.emptyRSUContainerHighFrequency),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EmptyRSUContainerHighFrequency,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
...
static asn_TYPE_tag2member_t asn_MAP_HighFrequencyContainer_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* emptyRSUContainerHighFrequency */
};
