...
static asn_TYPE_member_t asn_MBR_RoadWorksContainerExtended_1[] = {
	{ ATF_POINTER, 6, offsetof(struct RoadWorksContainerExtended, lightBarSirenInUse),
	...
	{ ATF_POINTER, 5, offsetof(struct RoadWorksContainerExtended, closedLanes),
	...
	{ ATF_POINTER, 4, offsetof(struct RoadWorksContainerExtended, restriction),
	...
	{ ATF_POINTER, 3, offsetof(struct RoadWorksContainerExtended, speedLimit),
	...
	{ ATF_POINTER, 2, offsetof(struct RoadWorksContainerExtended, incidentIndication),
	...
	{ ATF_POINTER, 1, offsetof(struct RoadWorksContainerExtended, recommendedPath),
...
static int asn_MAP_RoadWorksContainerExtended_oms_1[] = { 0, 1, 2, 3, 4, 5 };
