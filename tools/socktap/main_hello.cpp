...
int main(int argc, const char** argv)
{
    ...
    try {
        ...
        security::CertificateValidity certificate_validity;
        security::VerificationReport verification_report;
        security::SignService sign_service = security::dummy_sign_service(trigger.runtime(), nullptr);
        security::VerifyService verify_service = security::dummy_verify_service(verification_report, certificate_validity);
